...
export default function ConfidenceVsReconstructionPage() {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4 font-mono">
        ...
        <span className="text-xs uppercase text-muted-foreground tracking-widest">
          Loading confidence overlay comparison...
        </span>
      </div>
    )
  }
    ...
    <div className="flex h-full overflow-hidden border border-border bg-card/15 rounded-sm glow-cyan-sm font-mono text-slate-100">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-4 border-b border-border bg-muted/15 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <h1 className="text-md font-bold uppercase text-foreground flex items-center gap-1.5 mt-1">
              <Shield className="w-4.5 h-4.5 text-primary animate-pulse" />
              Confidence Overlay vs AI Reconstruction Output Comparison
            </h1>
          </div>
        ...
        <div className="flex-1 flex flex-col md:flex-row bg-black/65 overflow-hidden">
          ...
          {/* Left panel: Confidence overlay map */}
          <div className="flex-1 border-r border-border p-4 flex flex-col relative overflow-hidden">
            <div className="absolute top-6 left-6 bg-background/85 border border-border px-2.5 py-1 text-[9px] text-emerald-400 font-bold uppercase z-10 select-none flex items-center gap-1.5">
              ...
              <span>Confidence Overlay Map</span>
            </div>
            <div className="flex-1 overflow-auto flex items-center justify-center p-4 scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent">
              {overlayUrl ? (
                <img
                  src={overlayUrl}
                  alt="Confidence Overlay Preview"
                ...
                <div className="border border-dashed border-border bg-card/10 p-8 rounded-sm text-center flex flex-col items-center justify-center space-y-3 max-w-sm">
                  ...
                  <p className="text-[10px] text-muted-foreground font-sans leading-normal">
                    Confidence evaluation has not generated an overlay composite map yet.
                  </p>
                </div>
              )}
            </div>
            <div className="p-2 border border-border/40 bg-background/30 text-[9.5px] text-muted-foreground leading-normal font-sans space-y-2">
              <div className="flex items-center space-x-2">
                <span className="text-[8.5px] text-red-500 font-bold">Low Trust (Red)</span>
                <div className="w-20 h-1.5 bg-gradient-to-r from-red-500 via-yellow-400 to-emerald-400 border border-border/20 rounded-sm"></div>
                <span className="text-[8.5px] text-emerald-400 font-bold">High Trust (Green)</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 p-4 flex flex-col relative overflow-hidden">
            ...
            <div className="p-2 border border-border/40 bg-background/30 text-[9.5px] text-muted-foreground leading-normal font-sans">
              Displays the generative composite. Match the low-trust colors on the left to specific restored cloud patches on the right.
            </div>
          </div>
