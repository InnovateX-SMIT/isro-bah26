...
export default function PackageExportPanel({ sessionId, datasetId, datasetName, isSessionCompleted }: PackageExportPanelProps) {
  ...
  return (
    <div className="border border-border bg-card/25 p-5 font-mono space-y-5 relative overflow-hidden rounded-sm hover:border-primary/30 transition-all duration-300 xl:col-span-1">
      <div className="absolute top-0 right-0 bg-primary/10 border-l border-b border-border px-2.5 py-0.5 text-[8.5px] text-primary tracking-widest uppercase">
        CONTROL CENTER // PACKAGE EXPORTS
      </div>
